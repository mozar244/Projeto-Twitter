...
CREATE TABLE `admin_alerts` (
  ...
  CONSTRAINT `admin_alerts_ibfk_1` FOREIGN KEY (`tweet_id`) REFERENCES `tweets` (`id`) ON DELETE CASCADE,
  CONSTRAINT `admin_alerts_ibfk_2` FOREIGN KEY (`reporter_id`) REFERENCES `users` (`id`)
